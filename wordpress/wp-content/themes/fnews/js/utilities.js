(function($) {
	...
	function fnews_init_loading_effects() {
	...
	$( document ).ready(function() {
		...
		if (fnews_options && fnews_options.loading_effect) {
			
			fnews_init_loading_effects();
		}
