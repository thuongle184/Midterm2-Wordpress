		...
		<?php if ( ! post_password_required() ) : ?>
					...
					<?php if ( has_category() ) : ?>
							<span class="icon category-icon">
								<?php the_category( _x( ', ', 'Used between list items, there is a space after the comma.', 'fnews' ) ) ?>
							</span><!-- .category-icon -->						
					<?php endif; ?>
				
					<?php if ( has_tag() ) : ?>
							<span class="icon tags-icon">
								<?php the_tags( '', _x( ', ', 'Used between list items, there is a space after the comma.', 'fnews' ), '' ); ?>
							</span><!-- .tags-icon -->						
					<?php endif; ?>
